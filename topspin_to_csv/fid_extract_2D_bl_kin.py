...
#Convert 1D FID train to 2D when the experiment is stopped in the middle by halt
#TD_F1=90
#TD_F2=2048 #Half of F1 TD in TopSpin
#fid=fid[:TD_F1*TD_F2]
#fid=fid.reshape(fid.size//TD_F2,TD_F2)
TD=len(fid)

exp_time=oth.bl_FID_kin_time_axis(dic['acqus']['D'][5],TD,dic['acqus']['L'][5])
np.savetxt('exp_time.txt',exp_time)
# for a in fid[:,]:
#     plt.plot(a.real)
#     plt.plot(a.imag)
# plt.show()

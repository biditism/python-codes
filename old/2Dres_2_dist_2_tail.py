...
###############################################
#Define parameters and models for first tail
###############################################

Itot_model= Itot_model + lm.Model(my.T2_decay,prefix='tail1_')


dq_params.add('tail1_T2',tail_result['T2'],vary=True,
              min=tail_result['T2']*(1-tail_freedom),
              max=tail_result['T2']*(1+tail_freedom))
dq_params.add('tail1_A',tail_result['A'],vary=True,
              min=tail_result['A']*(1-tail_freedom),
              max=tail_result['A']*(1+tail_freedom))
dq_params.add('tail1_beta',tail_result['beta'],vary=False,min=0)


###############################################
#Define parameters and models for second tail
###############################################

Itot_model= Itot_model + lm.Model(my.T2_decay,prefix='tail2_')


dq_params.add('tail2_T2',tail_result['T2'],vary=True,
              min=tail_result['T2']*(1-tail_freedom),
              max=tail_result['T2']*(1+tail_freedom))
dq_params.add('tail2_A',tail_result['A'],vary=True,
              min=tail_result['A']*(1-tail_freedom),
              max=tail_result['A']*(1+tail_freedom))
dq_params.add('tail2_beta',tail_result['beta'],vary=False,min=0)

#Total tail fraction
dq_params.add('tail_A',tail_result['A'],vary=True, expr='tail1_A+tail2_A')
...
dq_params.add('second_A',0.5,vary=True,min=0.01,
              expr='1-(first_A+tail_A)')

...
###############################################
Idq_model= lm.Model(my.single_Dres_dq,prefix='first_')
...
dq_params.add('first_Dres',0.89,vary=True,min=0.9)
dq_params.add('first_T2',10,vary=True,min=0)
...
###############################################
Idq_model= Idq_model + lm.Model(my.single_Dres_dq,prefix='second_')


Itot_model= Itot_model + lm.Model(my.T2_decay,prefix='second_')

dq_params.add('second_Dres',0.05,vary=True,min=0)
dq_params.add('second_T2',20,vary=True,min=0)
...
dq_params.add('third_Dres',0.001,vary=True,min=0)
dq_params.add('third_T2',75,vary=True,min=0)

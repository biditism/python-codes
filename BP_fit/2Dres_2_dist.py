...
if __name__ == '__main__':
    ...
    ranges = {
        'first_Dres': (0.0001, 0.5), 'first_sigma': (0.001, 5), 'first_T2': (0.005, tail_result['T2']), 'first_A': (0.01, 0.99), 'first_beta': (0.8, 2),
    ...
    if exp_info['EXP'] == 'PNAG-low-pH':
        DQ_params['tail_beta'].set(value=1,vary=True)
    ...
    #DQ_params['second_T2'].set(vary=False)
    #DQ_params['second_beta'].set(vary=False)
    #DQ_params['second_A'].set(value=0.000,vary=False)
    #DQ_params['second_sigma'].set(value=0.001,vary=False)
    #DQ_params['second_Dres'].set(value=0.00,vary=False)
    ##############################################
    ...
    map_parameters= ['first_A','second_A','first_Dres','first_sigma']
    ...
    components_DQ = {}
    for x in connectivity:
        components_DQ[x] = fn.DQ_dist_Dres_1_T2(fittau, result[f'{x}_Dres'], result[f'{x}_sigma'], result[f'{x}_T2'], 

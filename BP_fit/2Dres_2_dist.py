...
def DQ_intensity(tau, tail_A,
                 ...
                 second_Dres,second_sigma,second_T2,second_beta,second_A):  
    
    first_comp= fn.DQ_dist_Dres_1_T2(tau, first_Dres,first_sigma, first_T2, first_A, first_beta)   
    
    second_comp= fn.DQ_dist_Dres_1_T2(tau, second_Dres,second_sigma, second_T2, second_A, second_beta)
...
ranges = {
    'first_Dres': (0.05, 0.2), 'first_sigma': (0.001, 0.5), 'first_T2': (1, 20), 'first_A': (0.01, 0.9), 'first_beta': (0.5, 2),
    'second_Dres': (0.005, 0.05), 'second_sigma': (0.001, 0.5), 'second_T2': (20, 40), 'second_A': (0.01, 0.9), 'second_beta': (0.5, 2),

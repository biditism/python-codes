...
ranges = {
    ...
    'third_Dres': (0.001, 0.005), 'third_T2': (40, 80), 'third_A': (0.01, 0.9), 'third_beta': (0.5, 2),
...
DQ_params.add('total_A',0.9999,vary=True,min=0.999,max=1,
              expr='first_A+second_A+third_A+tail_A')

if force_1:
    DQ_params['tail_A'].set(expr='1-first_A-second_A-third_A')
##############################################

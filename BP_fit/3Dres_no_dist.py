...
def DQ_intensity(tau, tail_A,
                 ...
                 third_Dres,third_T2,third_beta,third_A):  
    ...
    third_comp= fn.DQ_1_Dres_1_T2(tau, third_Dres, third_T2, third_A, third_beta)
...
ranges = {
    ...
    'third_Dres': (0.0001, 0.5), 'third_T2': (0.5, tail_result['T2']), 'third_A': (0.01, 0.99), 'third_beta': (0.5, 2),
...
DQ_params.add('diff_Dres_2', expr='second_Dres-third_Dres')
DQ_params.add('diff_T2_2', expr='third_T2-second_T2')
